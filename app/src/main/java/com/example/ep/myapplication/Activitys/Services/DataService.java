...
private  ArrayList<State> arrState = new ArrayList<>();
    ...
    public static class StateArrTask extends AsyncTask<Void, Void, Void> {
        private mainFirstFragment fragment;
        private ArrayList<State> arrState = new ArrayList<State>();

        public StateArrTask(mainFirstFragment fragment) {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            fragment.populateRecycleView(arrState);
        }
    }
}
